...
Automatically scans photos for NSFW content using OpenNSFW2 model
and organizes them based on sensitivity thresholds.
...
class PhotoCleaner:
    """Main class for NSFW photo detection and organization."""
    ...
    def __init__(self, threshold: float = 0.7, output_dir: str = None, verbose: bool = False):
        ...
        self.model_url = "https://github.com/bhky/opennsfw2/releases/download/v0.10.0/open_nsfw_weights.h5"
        self.model_path = "open_nsfw_weights.h5"
    ...
    def download_model(self):
        """Download the OpenNSFW2 model if not present."""
        if os.path.exists(self.model_path):
            self.logger.info("Model already exists, skipping download.")
            return
            
        self.logger.info("Downloading OpenNSFW2 model...")
        try:
    ...
    def load_model(self):
        """Load the OpenNSFW2 model."""
        try:
            # Download model if needed
            self.download_model()
            
            # Create the model architecture
            self.model = self.create_opennsfw2_model()
    ...
    def create_opennsfw2_model(self):
        """Create the OpenNSFW2 model architecture."""
    ...
    def predict_nsfw(self, image_path: str) -> float:
        ...
        try:
            ...
            # Return NSFW probability (index 1)
            nsfw_probability = float(prediction[0][1])
    ...
    def generate_report(self, stats: Dict, output_dir: str):
        ...
        with open(report_path, 'w') as f:
            f.write("Photo Cleaner Scan Report\n")
            f.write("=" * 30 + "\n\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Photo Cleaner - NSFW Content Detection Tool",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python photo_cleaner.py -i "C:\\Photos\\Vacation"
  python photo_cleaner.py -i "C:\\Photos" -t 0.5 --dry-run
